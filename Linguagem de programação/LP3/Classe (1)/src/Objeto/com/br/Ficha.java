...
public class Ficha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JBExibir.setBackground(new java.awt.Color(51, 51, 51));
        JBExibir.setForeground(new java.awt.Color(204, 204, 204));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(JBExibir, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(JBExibir, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28))
        );
    ...
    private void JBLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBLimparActionPerformed
        ...
        if(JTMatricula.getText().isEmpty() && JTNome.getText().isEmpty() && JTEndereco.getText().isEmpty() && JTNumero.getText().isEmpty() && JTBairro.getText().isEmpty() && JTMunicipio.getText().isEmpty()){
            JOptionPane.showMessageDialog(rootPane, "ERRO: não há espaços a serem apagados.");
        }else{
            JTMatricula.setText("");
            JTNome.setText("");
            JTEndereco.setText("");
    ...
    private void JBExibirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBExibirActionPerformed
        ...
        try{
            ...
            dados.setMunicipio(JTMunicipio.getText());
            dados.setBairro(JTBairro.getText());
            dados.setEndereco(JTEndereco.getText());
            dados.setNome(JTNome.getText());
            dados.setUf(JCUf.getSelectedItem().toString());
            dados.setMatricula(Integer.parseInt(JTMatricula.getText()));
            dados.setNumero(Integer.parseInt(JTNumero.getText()));
